...
### 添加第三方订阅源
sed -i '$a src-git-full kiddin9_openwrt_packages https://github.com/kiddin9/openwrt-packages.git' feeds.conf.default
sed -i '$a src-git-full kenzok8_openwrt_packages https://github.com/kenzok8/openwrt-packages.git' feeds.conf.default
sed -i '$a src-git-full kenzok8_small_package https://github.com/kenzok8/small-package.git' feeds.conf.default
